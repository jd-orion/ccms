...
theTest('时间选择- 配置默认格式', { value: '2020' }, { defaultValue: { source: 'static', value: '2020' } }, '2020', moment('2020').format('YYYY-MM-DD HH:mm:ss'))
theTest('时间选择- 配置时间格式 年', { value: '2020' }, { defaultValue: { source: 'static', value: '2020' }, submitFormat: 'YYYY' }, '2020', moment('2020').format('YYYY'))
theTest('时间选择- 配置时间格式 月', { value: '2020' }, { defaultValue: { source: 'static', value: '2020' }, submitFormat: 'MM' }, '2020', moment('2020').format('MM'))
theTest('时间选择- 配置时间格式 时分秒', { value: '2020' }, { default: { type: 'static', value: '2020' }, submitFormat: 'HH:mm:ss' }, '2020', moment('2020').format('HH:mm:ss'))
theTest('时间选择- 配置时间格式', { value: '2020' }, { default: { type: 'static', value: '2020' }, submitFormat: 'YYYY' }, '2020', moment('2020').format('YYYY'))
